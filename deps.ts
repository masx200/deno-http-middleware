...
import { METHODS } from "https://deno.land/std@0.162.0/node/http.ts";
import { assertFalse } from "https://deno.land/std@0.162.0/testing/asserts.ts";
import {
    ConnInfo,
    serve_http as serve,
...
export { STATUS_TEXT } from "https://deno.land/std@0.162.0/http/http_status.ts";
export { encode };
...
export { assertFalse };
export { METHODS };
export { html, json, text } from "https://esm.sh/@hattip/response@0.0.20";
