...
import { encode } from "https://deno.land/std@0.157.0/encoding/hex.ts";
import { METHODS } from "https://deno.land/std@0.157.0/node/http.ts";
import { assertFalse } from "https://deno.land/std@0.157.0/testing/asserts.ts";
import {
    ConnInfo,
    serve_http as serve,
...
export { STATUS_TEXT } from "https://deno.land/std@0.157.0/http/http_status.ts";
export { encode };
