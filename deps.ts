...
import { encode } from "https://deno.land/std@0.139.0/encoding/hex.ts";
import { assertFalse } from "https://deno.land/std@0.139.0/testing/asserts.ts";
export { encode };
...
export { assertFalse };
import { METHODS } from "https://deno.land/std@0.139.0/node/http.ts";
export { METHODS };
