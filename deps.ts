...
import { encode } from "https://deno.land/std@0.177.1/encoding/hex.ts";
import { METHODS } from "node:http";
import { assertFalse } from "https://deno.land/std@0.177.1/testing/asserts.ts";
import {
    ConnInfo,
    serve_http as serve,
...
export { STATUS_TEXT } from "https://deno.land/std@0.177.1/http/http_status.ts";
export { encode };
