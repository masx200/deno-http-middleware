...
/** CORS middleware
 * https://github.com/hattipjs/hattip/tree/main/packages/middleware/cors
 */
export function cors(options: CorsOptions = {}): Middleware {
    ...
    return async function cors(ctx: Context, next) {
        ...
        const response = ctx.request.method === "OPTIONS"
...
export interface CorsOptions {
    ...
    origin?:
        | string
        | ((ctx: Context) => string | false | Promise<string | false>);
